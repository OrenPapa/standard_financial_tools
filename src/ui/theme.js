export const colors = {
  ...
  amber: cssVar('--chart-amber', '#fbbf24'),
  cyan: cssVar('--chart-cyan', '#22d3ee'),
  rose: cssVar('--chart-rose', '#fb7185'),
...
export function refreshThemeColors() {
  Object.assign(colors, {
    ...
    amber: cssVar('--chart-amber', colors.amber),
    cyan: cssVar('--chart-cyan', colors.cyan),
    rose: cssVar('--chart-rose', colors.rose),
