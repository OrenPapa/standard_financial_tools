...
- `docs/budget-tracker.md`: recurring income, expenses, monthly cash flow, and balance projection formulas.
...
- `budget`: Budget Projection with recurring income, expenses, and balance forecast.
